...
/* eslint-disable no-restricted-syntax, no-use-before-define, prefer-template, no-console */
...
import { blue, cyan, red, reset, white } from "kolorist";
...
async function init() {
  ...
  const defaultTargetDir = "uikit-app";
